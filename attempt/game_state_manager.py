...
class GameStateManager:
    def __init__(self, screen):
        ...
        try:
            ...
            print("Could not initialize sound - continuing without audio")
            self.sound_manager = None
        
        # Initialize player (persistent across states)
        self.player = Player(400, 300, 0)  # Start in town center
        
        # Initialize all game states (pass sound manager to them)
        ...
        # Pass sound manager to states that need it
